...
سجلت أسعار زيت الزيتون في الأسواق الأسبوعية وبنقاط البيع المباشرة انخفاضاً يتراوح بين 15% إلى 25% مقارنة بنفس الفترة من العام الماضي...`,
  ...
  useEffect(() => {
    ...
    INITIAL_DATA.forEach(initialPost => {
      ...
      if (existingIndex === -1) {
        ...
        // تحديث البيانات إذا تغيرت الصورة أو العنوان في الكود
